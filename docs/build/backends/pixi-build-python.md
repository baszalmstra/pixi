...
- `requires-python = ">=3.9"` → `python_abi >=3.9,<3.10a0`
- `requires-python = ">=3.11,<4"` → `python_abi >=3.11,<3.12a0`
- If `requires-python` is not specified, defaults to `python_abi >=3.8,<3.9a0`
